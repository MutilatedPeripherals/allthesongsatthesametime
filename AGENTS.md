...
- `main.py` — entry point. Runnable directly: `python main.py -b <band> [-a <album>] [-o <outdir>]`. Album requires band. `-o` sets the output directory (created if missing), default `challenges/`.
